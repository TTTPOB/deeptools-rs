...
1. **Extract shared task driver** – Move the duplicated task creation and Rayon execution into `pipeline::core::task_runner`, returning either collected rows or streaming callbacks. Ensure existing unit tests still pass.
