...
- at the beginning of each session, read rust_plan.md to understand current progress, after each code change, update rust_plan.md to reflect current status
