...
- at the beginning of each session, read `plans/overall status.md` to understand current progress, after each code change, update `plans/overall status.md` to reflect current status
